...
!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ? t(exports, require("@tensorflow/tfjs"), require("util"))
    : "function" == typeof define && define.amd
    ? define(["exports", "@tensorflow/tfjs", "util"], t)
    : t((e.speechCommands = {}), e.tf, null);
})(this, function (e, t, r) {
  "use strict";
  var n = function (e, t) {
    return (n =
                    ...
                    : (this.freqDataQueue.push(
                      ...
                      this.tracker.tick()
                        ? ((e = p(this.freqDataQueue)),
                          ...
                          (n = void 0),
                          this.includeRawAudio &&
                            ((a = p(this.timeDataQueue)),
                            (n = f(a, [1, this.numFrames * this.fftSize]))),
        ...
        if (((this.examples = {}), (this.label2Ids = {}), null != e))
          for (
            ...
            null != i.rawAudioNumSamples && (s += i.rawAudioNumSamples),
              (s *= 4),
              this.addExample(T({ spec: i, data: r.data.slice(n, n + s) })),
              (n += s);
          }
      }
      return (
        ...
        (e.prototype.getData = function (e, r) {
          ...
          null != e
            ? t.util.assert(-1 !== a.indexOf(e), function () {
                return (
                  "Label " +
                  e +
          ...
          1 === l.length
            ? ((i = null == r.numFrames ? l[0] : r.numFrames),
              (s = null == r.hopFrames ? 1 : r.hopFrames))
            : ((i = r.numFrames),
              t.util.assert(
                null != i && Number.isInteger(i) && i > 0,
                function () {
                  return (
                    "There are " +
                    l.length +
          ...
          return t.tidy(function () {
                ...
                var y = n.label2Ids[v],
                  b = function (a) {
                    ...
                    var w = y.data.length / b,
                      x = null;
                    "_background_noise_" !== v &&
                      (x =
                        null == y.keyFrameIndex
                          ? z(y).dataSync()[0]
                          : y.keyFrameIndex);
                    var S = t.tensor3d(y.data, [w, b, 1]),
                      ...
                      T = function (n) {
                        ...
                        r.getDataset ? f.push(a.dataSync()) : p.push(a),
                          null == e && m.push(g);
                      };
                    try {
                      for (
                        var M = ((l = void 0), o(E)), D = M.next();
                        !D.done;
                        D = M.next()
                      ) {
                        T(D.value);
              ...
              var D = M.map(function (e) {
                ...
                I = (function (e, r, n) {
                  ...
                  if (p) {
                    ...
                    try {
                      for (var A = o(w), R = A.next(); !R.done; R = A.next())
                  ...
                  (T = []), (F = []), (M = []), (z = []);
                  try {
                    for (var O = o(b), C = O.next(); !C.done; C = O.next())
                      (L = C.value), T.push(e[L]), F.push(r[L]);
                  } catch (e) {
                    u = { error: e };
                  } finally {
                    try {
                  ...
                  try {
                    for (var k = o(w), _ = k.next(); !_.done; _ = k.next())
            ...
            var P =
              null == e
                ? t.oneHot(t.tensor1d(m, "int32"), a.length).asType("float32")
                : void 0;
            return { xs: t.stack(p), ys: P };
          });
        }),
        (e.prototype.augmentByMixingNoise = function (e, r, n) {
          ...
          for (
            ...
            "_background_noise_" === l[r[p]] ? c.push(p) : d.push(p);
          if (0 === c.length)
            throw new Error(
        ...
        (e.prototype.serialize = function (e) {
          ...
          return (
            (l = { manifest: p, data: g(f) }),
            (u = y(JSON.stringify(l.manifest))),
            (c = y(w)),
            (h = new Uint32Array([x])),
            (d = new Uint32Array([u.byteLength])),
            g([g([c, h.buffer, d.buffer]), u, l.data])
          );
        }),
        e
      );
  ...
  var R = (function () {
      ...
      return (
            ...
            return s(this, function (m) {
              switch (m.label) {
                ...
                case 1:
                  ...
                  return (
                    (o = null == r.overlapFactor ? 0.5 : r.overlapFactor),
                    t.util.assert(o >= 0 && o < 1, function () {
                      return (
                        "Expected overlapFactor to be >= 0 and < 1, but got " +
                        o
                      );
                          ...
                          switch (s.label) {
                            ...
                            case 1:
                              return (
                                s.sent(),
                                (w = l(
                                  this.modelWithEmbeddingOutput.predict(i),
                                  2
                                )),
                                (c = w[0]),
                                (d = w[1]),
                            ...
                            case 4:
                              return (
                                (p = s.sent()), [4, (f = c.argMax(-1)).data()]
                              );
                            case 5:
                              return (
                                (m = s.sent()[0]),
                                (g = Math.max.apply(Math, u(p))),
                                t.dispose([c, f, i]),
                                g < n ? [2, !1] : [3, 6]
                              );
                            case 6:
                ...
                case 1:
                  return (
                    ...
                    "string" != typeof this.modelArtifactsOrURL
                      ? [3, 3]
                      : [4, t.loadLayersModel(this.modelArtifactsOrURL)]
                  );
                case 2:
                  return (e = s.sent()), [3, 5];
                case 3:
                ...
                case 5:
                  ...
                  return (
                    ...
                    (n =
                      ...
                      1e3),
                    (a = e.inputs[0].shape[1]),
                    (this.parameters.spectrogramDurationMillis = a * n),
                    [2]
                  );
              }
            });
            ...
            return s(this, function (n) {
              switch (n.label) {
                ...
                case 1:
                  ...
                  return (
                    (this.modelWithEmbeddingOutput = t.model({
          ...
          return i(this, void 0, void 0, function () {
            ...
            return s(this, function (s) {
              switch (s.label) {
                ...
                case 1:
                  return (
                    s.sent(), null != e ? [3, 3] : [4, this.recognizeOnline()]
                  );
                case 2:
                      ...
                      return i(e, void 0, void 0, function () {
                        ...
                        return s(this, function (i) {
                          switch (i.label) {
                            case 0:
                              return (
                                (e = h(r)), [4, this.audioDataExtractor.stop()]
                              );
                            case 1:
        ...
        (e.prototype.freezeModel = function () {
          ...
          try {
            for (
              var r = o(this.model.layers), n = r.next();
              !n.done;
              n = r.next()
            ) {
              n.value.trainable = !1;
      ...
      return (
          ...
          return i(this, void 0, void 0, function () {
            ...
            return s(this, function (p) {
              ...
              return (
                ...
                (o = this.parameters.fftSize / this.parameters.sampleRateHz),
                (l = o * n),
                (this.streaming = !0),
                [
                  2,
                            ...
                            switch (s.label) {
                              ...
                              case 6:
                                return (
                                  x.apply(void 0, [
                                    ((S.data = s.sent()),
                                    (S.frameSize = this.nonBatchInputShape[1]),
                                    S),
                                  ]),
                                  [3, 13]
                                );
                              ...
                              case 9:
                                return (
                                  ...
                                  (L = (I = this.dataset).addExample),
                                  (A = { label: e, spectrogram: D }),
                                  r.includeRawAudio
                                    ? ((O = {}), [4, o.data()])
                                    : [3, 11]
                                );
        ...
        (r.prototype.collectTransferDataAsTensors = function (e, t) {
          ...
          var n = Math.round(e * r),
            i = this.dataset.getData(
              null,
              a({ numFrames: r, hopFrames: n }, t)
            );
              ...
              switch (s.label) {
                ...
                case 1:
                  return (
                    ...
                    console.log(
                      "fitDataset() took " +
                        (t.util.now() - u).toFixed(2) +
                        " ms"
                    ),
                    null != e.fineTuningEpochs && e.fineTuningEpochs > 0
                      ? ((h = t.util.now()),
                        [4, this.fineTuningUsingTfDatasets(e, i, o)])
                      : [3, 3]
                  );
                case 2:
                  return (
              ...
              switch (s.label) {
                    ...
                    null != e.validationSplit
                      ? ((c = (function (e, r, n) {
                          return (
                            ...
                            t.tidy(function () {
                              for (
                                var a = r.argMax(-1).dataSync(), i = [], s = 0;
                                s < a.length;
                                ++s
                              ) {
                                var o = a[s];
                ...
                case 2:
                  return (
                    (h = s.sent()),
                    null != e.fineTuningEpochs && e.fineTuningEpochs > 0
                      ? [4, this.fineTuningUsingTensors(e, o, l, u)]
                      : [3, 4]
                  );
                case 3:
                  ...
                  t.tidy(function () {
                    for (
                      var a = [],
                        ...
                        u = n.model.predict(o),
                        c = u
                          .slice([0, 1], [u.shape[0], u.shape[1] - 1])
                          .max(-1),
                        h = u.shape[0],
                        d = 0;
        ...
        (r.prototype.createTransferModelFromBaseModel = function () {
          ...
          (this.transferHead = t.sequential()),
          ...
          this.model = t.model({ inputs: this.baseModel.inputs, outputs: i });
        }),
          ...
          return i(this, void 0, void 0, function () {
            ...
            return s(this, function (a) {
              return (
                ...
                (e = e || C(this.name)),
                t ||
                  ((r = A.localStorage.getItem(I)),
                  ((n = null == r ? {} : JSON.parse(r))[this.name] =
                    this.getMetadata()),
                  A.localStorage.setItem(I, JSON.stringify(n))),
              ...
              switch (i.label) {
                case 0:
                  if (((r = null != e), (e = e || C(this.name)), !r)) {
                    if (
                      null == (n = JSON.parse(A.localStorage.getItem(I))) ||
                      null == n[this.name]
                    )
                      throw new Error(
                    ...
                    (this.words = n[this.name].wordLabels),
                      console.log(
  ...
  (e.create = function (e, r, n, a) {
    ...
    (e.Dataset = S),
    (e.getMaxIntensityFrameIndex = z),
    (e.spectrogram2IntensityCurve = M),
      ...
      return i(this, void 0, void 0, function () {
        ...
        return s(this, function (n) {
          switch (n.label) {
            case 0:
              return (
                null == (r = JSON.parse(A.localStorage.getItem(I))) && (r = {}),
                null != r[e] && delete r[e],
                A.localStorage.setItem(I, JSON.stringify(r)),
                [4, t.io.removeModel(C(e))]
              );
            case 1:
              return n.sent(), [2];
          }
          ...
          switch (a.label) {
            ...
            case 1:
              for (n in ((e = a.sent()), (r = []), e))
                n.startsWith(L) && r.push(n.slice(L.length));
              return [2, r];
          }
        });
      });
